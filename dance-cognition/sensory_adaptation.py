...
class SensoryAdapter:
    def __init__(self):
        self._background = Vector3d(0.0, 0.0, 0.0)

    def process(self, signal, time_increment):
        self._background += (signal - self._background) * 0.2 * min(time_increment, 1.0)
        return signal - self._background
